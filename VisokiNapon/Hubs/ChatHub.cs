...
namespace VISOKI_NAPON.Hubs
{
    ...
    public class ChatHub : Hub
    {
		...
		* string answerMessage - tender-players answer on question <br>
		* string requestedAmountMessage - amount of money tender-player wants for his answer */
		...
		* string questionValueMessage - value of question */
		...
		/** ### Desctiption
        * Function that informs tneder-player that he gave correct answer, i.e. informs him that he won wanted amount of money
        * ### Arguments
